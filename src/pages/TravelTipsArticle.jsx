...
export default function TravelTipsArticle() {
  ...
  const sidebarItems = [
    { slug: "best-time", icon: Calendar, title_en: "Best Time to Visit", title_id: "Waktu Terbaik Berkunjung" },
    { slug: "pack", icon: Backpack, title_en: "What to Pack", title_id: "Barang Bawaan" },
    { slug: "etiquette", icon: Heart, title_en: "Local Etiquette", title_id: "Etiket Lokal" },
    { slug: "safety", icon: Shield, title_en: "Safety Tips", title_id: "Tips Keamanan" },
    { slug: "budget", icon: Wallet, title_en: "Budget Tips", title_id: "Tips Anggaran" },
    { slug: "language", icon: Languages, title_en: "Language Basics", title_id: "Dasar Bahasa" }
  ];
  ...
  const breadcrumbItems = [
    ...
    { label: language === "id" ? "Tips Perjalanan" : "Travel Tips", to: "/plan-your-trip/travel-tips" },
    { label: title }
  ];
            ...
            <nav className="space-y-1">
              {sidebarItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.slug}
                    to={`/plan-your-trip/travel-tips/${item.slug}`}
