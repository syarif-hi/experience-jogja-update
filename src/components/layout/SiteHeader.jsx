...
export default function SiteHeader() {
  ...
  const wordmark = (
    <Link to="/" className="focus-ring flex flex-1 md:flex-none md:shrink-0 flex-col gap-1 rounded-md leading-none">
      ...
      <img src={assetUrl("/brand-logo-color-9.png")} alt="Experience Jogja" className="w-full h-auto md:w-auto min-[608px]:max-h-[57px] min-[608px]:pt-0 min-[820px]:max-h-[47px] min-[820px]:pt-0 lg:max-h-[107px] lg:pt-[20px] object-contain object-left" />
    </Link>
  );
